    ...
    <div class="container mx-auto px-4">
        <div class="flex space-x-8">
            ...
            <div class="relative group">
                ...
                <div class="absolute left-0 mt-2 w-48 bg-white text-gray-800 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
                    <a href="{{ route('empleados.index') }}" class="block px-4 py-2 hover:bg-gray-100">Lista de Empleados</a>
                    <a href="{{ route('empleados.create') }}" class="block px-4 py-2 hover:bg-gray-100">Nuevo Empleado</a>
                </div>
            </div>
